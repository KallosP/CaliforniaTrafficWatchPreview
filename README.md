![Feature_Graphic](./assets/Feature_Graphic.png)
...
## Android Download
CTW is fully complete, however, it's currently required to be in closed testing. If you're interested in trying it out, please follow [these](https://github.com/KallosP/CaliforniaTrafficWatchPreview/blob/main/ANDROID_INSTALL.md) instructions for installation.
